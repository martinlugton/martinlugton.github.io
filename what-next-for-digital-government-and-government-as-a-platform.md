...
# What next for digital government and government as a platform?
...
GDS started by bringing together hundreds of disparate government websites into a single domain, with a vastly improved user experience, overhauling content and a number of key transactional services. 
...
These are large-scale platforms: each week Pay processes around £30m and Notify sends around 13 million emails, 14 million text messages, and 200,000 letters; the Design System is used on thousands of services.
...
We want to deliver the public a smoother, more proactive and personalised experience of interacting with government. Working back from this target experience, much of the work ahead is clear, and is largely about catching up to what users already expect from digital services. Data sharing across services, where users consent, to reduce effort and friction, better control of the communication experience, the understanding and anticipation of user circumstances and needs to drive proactive action to help people when they need it, without them having to be experts in government; all underpinned by a smooth, secure and ubiquitous way to prove your identity. This will take a lot of work.

## What's the strategy for delivering this at scale?

This desired future requires two waves of transformation - taking what currently exists to a higher degree of interconnected sophistication, and getting the current long tail of 9,000 non-transformed document-driven services (PDFs or otherwise) up to this standard.
...
Alongside this, we have an opportunity to be ambitious about our vision for the future of government services. We can think about emerging capabilities and their trajectory, and make some confident bets on the future. This helps us to go beyond just catching up to where we should already be, and to focus on a future-facing transformation of government services.

## The next step for government as a platform is a service transformation engine

The next step for government as a platform is a service transformation engine that uses AI and data to drive the delivery of great experiences across all services, and continuously optimise them.

The Digital Service Platforms programme’s work on a joined-up service platform will, by the end of 24/5, allow government to quickly and effectively create whole services, whatever the service team’s access to technical skills.. 

From there, we’ll be able to take the next step and orient government’s platform offering to helping people create great services, and powering government-wide continuous service transformation, harnessing the power of network effects, data and artificial intelligence. We will do this by empowering service teams to make great design decisions upfront, and through data- and AI-driven improvement to individual services and all services on our platform over time.
...
As these capabilities continue to mature, we’ll be able to help government design and build better services from the start - improving policy formation and service design. There’s an opportunity here to collaborate with CDDO on empowering policy colleagues to more effectively transmit policy into reality.

Design decisions over the next 5 years will become harder rather than easier. Service interactions will likely be increasingly mediated through AI agents and through more personalised or multimodal interaction patterns rather than flat HTML pages. Designing for these interactions, and distilling best practice into readily available components, will be a key role for GDS. Similarly, trust will become increasingly scarce, and we’ll need to design for the retention and reinforcement of trust in government in ways that go beyond the visual recognition of the GOV.UK Design System and GOV.UK Frontend library. 
...
## We will drive perpetual improvement to individual services, and to the wider service platform

We will achieve this by harnessing data and artificial intelligence and applying it to the GDS service platform.

Digital government in the UK has never had good insight into how well services are performing. GOV.UK is working hard to address some of this, joining up the disconnect of service data between www.gov.uk (where the content lives) and services.gov.uk (where the services live) through the [Single Data Environment](https://gds.blog.gov.uk/2022/10/17/the-single-data-environment-joined-up-digital-analytics/). This will start to build a foundation of data on how users interact with services and where they have problems, and it will allow individual parts of bigger services to get a joined up view of the bigger picture.
...
This is where we harness network effects. At the moment we don’t really make use of the benefits of having so many services using our products. In the next 5 years we’ll change this, and use the scale of government digital delivery to help improve the quality of digital services over time.
